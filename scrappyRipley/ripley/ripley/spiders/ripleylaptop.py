...
class RipleylaptopSpider(scrapy.Spider):
    name = 'ripleylaptop'

    def start_requests(self):
        #url = 'https://simple.ripley.com.pe/tecnologia/computacion-gamer/camaras-web?source=menu'
        url = 'https://simple.ripley.com.pe/tecnologia/computacion/laptops'
    ...
    def parse_products(self, response):
        ...
        # atributo = response.xpath("//table[@class='table table-striped']/tbody/tr/td[1]/text()").getall()
        ...
        marca = response.xpath("//div[@class='rpl-product-description-wrapper']/table/tbody/tr[1]/td[2]/text()").get()
...
## pruebas por consola CMD
# 0° -> ABRIR EL CMD COMO ADMINISTRADOR
# 1° -> scrapy shell "http://localhost:8050/render.html?url=https://simple.ripley.com.pe/tecnologia/computacion/laptops&wait=4.0"
        ## scrapy shell "http://localhost:8050/render.html?url=https://simple.ripley.com.pe/laptop-hp-14-dq2023la-intel-core-i3-1115g4-8gb-ram-512gb-ssd-14-2004284813088p?s=o&wait=4.0"

#scrapy shell "http://localhost:8050/render.html?url=https://simple.ripley.com.pe/laptop-hp-14-dq2023la-intel-core-i3-1115g4-8gb-ram-512gb-ssd-14-2004284813088p?s=o&wait=4.0"

# 2° -> view(response)
# 3° -> response.css("h1::text").get()
